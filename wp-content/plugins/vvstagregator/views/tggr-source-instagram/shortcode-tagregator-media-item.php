...
<div id="<?php echo esc_attr( Tagregator::CSS_PREFIX . get_the_ID() ); ?>" class="<?php echo esc_attr( $css_classes ); ?>">
	...
	<a href="http://instagram.com/<?php echo esc_attr( $author_username ); ?>" class="<?php echo esc_attr( Tagregator::CSS_PREFIX ); ?>author-profile clearfix" target="_blank">
	...
	<div class="<?php echo esc_attr( Tagregator::CSS_PREFIX ); ?>item-content">
		<?php if ( $media ) : ?>
			<?php foreach ( $media as $media_item ) : ?>
				<?php if ( 'image' == $media_item['type'] ) : ?>
					<a href="<?php echo esc_attr( $media_permalink ); ?>" target="_blank">
		...
		<?php if ( $show_excerpt ) : ?>
			<?php the_excerpt(); ?>
			<p><a href="<?php echo esc_attr( $media_permalink ); ?>" target="_blank">See the rest of this description on Instagram</a></p>
		<?php else : ?>
			<?php the_content(); ?>
		<?php endif; ?>
	</div>

	<a href="<?php echo esc_attr( $media_permalink ); ?>" class="<?php echo esc_attr( Tagregator::CSS_PREFIX ); ?>timestamp" target="_blank">
